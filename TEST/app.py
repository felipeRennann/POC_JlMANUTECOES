...
def editar_funcionario(nomeFuncionario):
    ...
    if nomeFuncionario not in funcionario_dict:
    ...
    funcionario_dict[nomeFuncionario]['numero_cpf'] = data.get('cpf', funcionario_dict[nomeFuncionario]['numero_cpf'])
    funcionario_dict[nomeFuncionario]['chave_pix'] = data.get('chave_pix', funcionario_dict[nomeFuncionario]['chave_pix'])
    funcionario_dict[nomeFuncionario]['valor_hora_base'] = data.get('valor_hora_base', funcionario_dict[nomeFuncionario]['valor_hora_base'])
    funcionario_dict[nomeFuncionario]['valor_hora_extra_um'] = data.get('valor_hora_extra_um', funcionario_dict[nomeFuncionario]['valor_hora_extra_um'])
    funcionario_dict[nomeFuncionario]['valor_hora_extra_dois'] = data.get('valor_hora_extra_dois', funcionario_dict[nomeFuncionario]['valor_hora_extra_dois'])
    funcionario_dict[nomeFuncionario]['adicional_noturno'] = data.get('adicional_noturno', funcionario_dict[nomeFuncionario]['adicional_noturno'])
    funcionario_dict[nomeFuncionario]['repouso_remunerado'] = data.get('repouso_remunerado', funcionario_dict[nomeFuncionario]['repouso_remunerado'])
    funcionario_dict[nomeFuncionario]['valor_ferias'] = data.get('valor_ferias', funcionario_dict[nomeFuncionario]['valor_ferias'])
    funcionario_dict[nomeFuncionario]['valor_um_terco_ferias'] = data.get('valor_um_terco_ferias', funcionario_dict[nomeFuncionario]['valor_um_terco_ferias'])
    funcionario_dict[nomeFuncionario]['valor_decimo_terceiro'] = data.get('valor_decimo_terceiro', funcionario_dict[nomeFuncionario]['valor_decimo_terceiro'])
    funcionario_dict[nomeFuncionario]['pagamento_fgts'] = data.get('pagamento_fgts', funcionario_dict[nomeFuncionario]['pagamento_fgts'])
    funcionario_dict[nomeFuncionario]['desconto_inss'] = data.get('desconto_inss', funcionario_dict[nomeFuncionario]['desconto_inss'])
    funcionario_dict[nomeFuncionario]['desconto_refeicao'] = data.get('desconto_refeicao', funcionario_dict[nomeFuncionario]['desconto_refeicao'])
    funcionario_dict[nomeFuncionario]['desconto_transporte'] = data.get('desconto_transporte', funcionario_dict[nomeFuncionario]['desconto_transporte'])
     
     
    CriarFuncionario.salvar_cargos(funcionario_dict)
     
    logger.debug(f'Dados do funcionário após atualização: {funcionario_dict[nomeFuncionario]}')
    logger.info(f'Funcionário {nomeFuncionario} atualizado com sucesso: {funcionario_dict[nomeFuncionario]}')
    return jsonify({'message': 'Funcionário atualizado com sucesso', 'data': funcionario_dict[nomeFuncionario]}), 200
